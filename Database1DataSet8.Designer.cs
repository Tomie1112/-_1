...
namespace Приложение_для_курсовой.Database1DataSet8TableAdapters {
...
SELECT Код_сотрудника, ФИО_сотрудника, Роль, Контактный_телефон, Логин, Пароль, Статус, Дата_приема_в_работу, Дата_увольнения FROM Сотрудники_предприятия WHERE (Код_сотрудника = @Код_сотрудника)";
...
SELECT Код_сотрудника, ФИО_сотрудника, Роль, Контактный_телефон, Логин, Пароль, Статус, Дата_приема_в_работу, Дата_увольнения FROM Сотрудники_предприятия WHERE (Код_сотрудника = @Код_сотрудника)";
        ...
        public virtual int Fill(Database1DataSet8.Сотрудники_предприятияDataTable dataTable) {
        ...
        public virtual Database1DataSet8.Сотрудники_предприятияDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet8.Сотрудники_предприятияDataTable dataTable = new Database1DataSet8.Сотрудники_предприятияDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet8.Сотрудники_предприятияDataTable dataTable) {
