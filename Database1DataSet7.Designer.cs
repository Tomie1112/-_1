...
namespace Приложение_для_курсовой.Database1DataSet7TableAdapters {
...
SELECT Номер_повторного_открытия_заявки, Номер_заявки, Причина_повторного_открытия_заявки FROM Повторное_открытие_заявок WHERE (Номер_повторного_открытия_заявки = @Номер_повторного_открытия_заявки)";
...
SELECT Номер_повторного_открытия_заявки, Номер_заявки, Причина_повторного_открытия_заявки FROM Повторное_открытие_заявок WHERE (Номер_повторного_открытия_заявки = @Номер_повторного_открытия_заявки)";
        ...
        public virtual int Fill(Database1DataSet7.Повторное_открытие_заявокDataTable dataTable) {
        ...
        public virtual Database1DataSet7.Повторное_открытие_заявокDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet7.Повторное_открытие_заявокDataTable dataTable = new Database1DataSet7.Повторное_открытие_заявокDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet7.Повторное_открытие_заявокDataTable dataTable) {
