...
namespace Приложение_для_курсовой {
    ...
    public partial class Database1DataSet1 : global::System.Data.DataSet {
        ...
        public partial class Работы_по_заявкамDataTable : global::System.Data.TypedTableBase<Работы_по_заявкамRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public Работы_по_заявкамRow AddРаботы_по_заявкамRow(int Номер_работы, int Номер_заявки, System.DateTime Дата_заполнения, string Действие_в_отношении_заявки, string Ход_работы) {
...
namespace Приложение_для_курсовой.Database1DataSet1TableAdapters {
...
SELECT Номер_работы, Номер_заявки, Дата_заполнения, Действие_в_отношении_заявки, Ход_работы FROM Работы_по_заявкам WHERE (Номер_работы = @Номер_работы)";
        ...
        public virtual int Fill(Database1DataSet1.Работы_по_заявкамDataTable dataTable) {
        ...
        public virtual Database1DataSet1.Работы_по_заявкамDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet1.Работы_по_заявкамDataTable dataTable = new Database1DataSet1.Работы_по_заявкамDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet1.Работы_по_заявкамDataTable dataTable) {
